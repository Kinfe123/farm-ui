  ...
  return (
    <section className="custom-screen-lg mb-[-40px] z-10 relative mt-32">
      ...
      <div className="max-w-xl ml-auto space-y-4 text-right">
        <h2 className="text-4xl md:text-5xl lg:text-7xl bg-gradient-to-tr from-zinc-100 via-zinc-400 to-zinc-200 font-display bg-clip-text text-transparent">Turn your ideas into reality</h2>

...
export default () => (
  <footer className="relative mt-40 pt-24 overflow-hidden">
    <div>
      ...
      <Image src={githubIcon} alt="github icon" className="absolute hidden md:block   -translate-x-1/2 -translate-y-1/2absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-tl-2xl z-20 opacity-30"/>

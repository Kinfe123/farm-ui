...
export default function FUILoginWithGridProvider() {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col items-center justify-center sm:px-4 relative">
      ...
      <div className="w-full  space-y-6 text-gray-600 sm:max-w-md md:max-w-xl lg:max-w-2xl px-5 py-3 rounded-2xl  transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset]">

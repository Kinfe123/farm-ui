        ...
        <div className="relative z-10 max-w-full  translate-y-[33%]  mr-auto  space-y-4">
          ...
          >
            <div className="mr-auto text-[0.84rem] ml-6 text-zinc-400 text-left md:text-lg lg:max-w-2xl md:py-5 ">
              ...
              <div className="mt-5 mb-6  border-input animate-background-shine bg-[linear-gradient(110deg,#000,55%,#4D4B4B,65%,#000)] bg-opacity-20 bg-[length:250%_100%]   border-[2px] py-2 px-4 rounded-lg flex gap-2 justify-center items-center">

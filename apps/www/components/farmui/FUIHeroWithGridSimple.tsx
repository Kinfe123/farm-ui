        ...
        >
          ...
          <div className="relative z-10 max-w-full  translate-y-[33%]  mx-auto space-y-4">
            ...
            <HeroAnimated
              ...
              headerClassName="text-center tracking-tight max-w-md md:max-w-6xl text-2xl md:text-7xl tracking-tighter mx-auto lg:text-8xl font-bold font-geist  font-normal  text-transparent bg-clip-text bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)] leading-0 md:leading-0 md:pb-0 mt-1"
              ...
              descriptionClassName="uppercase font-mono tracking-tighter mx-auto text-[0.84rem] text-zinc-400 text-center md:text-lg lg:max-w-2xl md:py-2"
            >
              <div className="mx-auto text-[0.84rem] text-zinc-400 text-left md:text-lg lg:max-w-2xl md:py-2 ">
                <p className=" tracking-tighter mx-auto uppercase font-mono max-w-md md:max-w-3xl text-wrap"></p>

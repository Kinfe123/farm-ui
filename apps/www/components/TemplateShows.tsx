  ...
  return (
    <div className="relative w-screen bg-transparent">
      ...
      <LinkItem
        href="/pricing"
        variant="shiny"
        className="relative group z-50  mx-auto mb-10 mb:mb-0  md:mt-10 flex w-fit justify-center items-center gap-x-2 border border-zinc-800 hover:border-zinc-600 bg-zinc-950/80 hover:text-zinc-100 duration-200 sm:w-fit py-4 px-10"
      >
        Get LifeTime Access

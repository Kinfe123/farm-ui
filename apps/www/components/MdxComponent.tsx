...
import { MdxTabs , MdxTab } from "components/MdxTab";
...
export const components = {
  ...
  h2: ({ className, ...props }) => (
      <h2
          className={cn(
              "mt-6 scroll-m-20 border-b pb-1 text-3xl font-normal font-geist tracking-tight first:mt-0",
              className,
          )}
          {...props}
      />
  ...
  h3: ({ className, ...props }) => (
      <h3
          className={cn("mt-4 scroll-m-20 text-2xl font-semibold tracking-normal", className)}
          {...props}
      />
  ),
  h4: ({ className, ...props }) => (
      <h4
          className={cn("mt-4 scroll-m-20 text-xl font-semibold tracking-tight", className)}
          {...props}
      />
  ),
  h5: ({ className, ...props }) => (
  ...
  h6: ({ className, ...props }) => (
      <h6
          className={cn("mt-4 scroll-m-20 text-base font-semibold tracking-tight", className)}
          {...props}
      />
  ),
  a: ({ className, ...props }) => (

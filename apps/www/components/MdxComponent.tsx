...
export const components = {
  ...
  h2: ({ className, ...props }) => (
      <h2
          className={cn(
              "mt-10 scroll-m-20 border-b pb-1 text-3xl font-normal font-geist tracking-tight first:mt-0",
              className,
          )}
          {...props}
      />
  ...
  h3: ({ className, ...props }) => (
      <h3
          className={cn("mt-8 scroll-m-20 text-2xl font-semibold tracking-normal", className)}
          {...props}
      />
  ),
  h4: ({ className, ...props }) => (

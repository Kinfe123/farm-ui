  ...
  return (
    <div className="mx-h-full relative mx-10 mt-44 z-20">
      ...
      <Image
        ...
        height={900}
        alt="bgback"
        className="absolute inset-x-0 top-[-300px] z-1 -translate-y-10 max-w-full mx-auto opacity-100"
      />
      <Image
        src={bgback}
        width={900}
        height={900}
        alt="bgback"
        className="absolute inset-x-0 top-[-300px] z-1 -translate-x-10 max-w-full mx-auto opacity-100"
      />
      <Image
        src={bgback}
        width={900}
      ...
      >
        ...
        <div className="absolute bittom-0 h-full left-0 w-full bg-black opacity-10 -z-20 "></div>
          ...
          <LinkItem
            ...
            className="inline-flex rounded-full mt-5 z-20 font-geist text-center group items-center w-full justify-center  bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent bg-zinc-900  border-input border-[1px] hover:bg-transparent/10 transition-colors sm:w-auto py-4 px-10"

    ...
    <section className="mt-52 mb-32 relative">
      <div className="custom-screen-lg z-[200px]">
        <div className="max-w-3xl mr-auto space-y-4 text-center">
          <h2 className="text-4xl text-left font-normal tracking-tighter  bg-gradient-to-tr from-zinc-100/80 via-zinc-200/95 to-zinc-100/50 text-transparent bg-clip-text  md:text-6xl lg:text-7xl font-geist md:leading-5 heading ">Use your favorite framework</h2>
